(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@onflow/util-logger'), require('@onflow/util-invariant'), require('uuid'), require('@onflow/typedefs'), require('@onflow/config'), require('@onflow/rlp'), require('@onflow/transport-http'), require('@onflow/util-address'), require('events'), require('sha3'), require('@onflow/util-template')) :
  typeof define === 'function' && define.amd ? define(['exports', '@onflow/util-logger', '@onflow/util-invariant', 'uuid', '@onflow/typedefs', '@onflow/config', '@onflow/rlp', '@onflow/transport-http', '@onflow/util-address', 'events', 'sha3', '@onflow/util-template'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.onflowSdk = {}, global.logger, global.utilInvariant, global.uuid, global.typedefs, global.config, global.rlp, global.transportHttp, global.utilAddress, global.EventEmitter, global.sha3, global.utilTemplate));
})(this, (function (exports, logger, utilInvariant, uuid, typedefs, config, rlp, transportHttp, utilAddress, EventEmitter, sha3, utilTemplate) { 'use strict';
  ...
  const decodeStream = (stream, decodeResponse, customDecoders) => {
    const newStream = new EventEmitter__default["default"]();
    let queue = taskQueue();
