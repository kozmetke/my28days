...
class RpcClient {
  constructor(_ref) {
    ...
    _defineProperty(this, "setSend", () => {});
    _defineProperty(this, "_send", new Promise(resolve => {
      this.setSend = resolve;
    }));
    _defineProperty(this, "peerInfo", new Promise((resolve, reject) => {
      this.resolvePeerInfo = resolve;
      this.rejectPeerInfo = reject;
    }));
    _defineProperty(this, "enabledNotifications", []);
    _defineProperty(this, "requestHandlers", {});
    _defineProperty(this, "subscriptions", {});
    _defineProperty(this, "messageListeners", []);
