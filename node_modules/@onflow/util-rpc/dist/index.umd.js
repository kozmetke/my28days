(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["onflowUtil-rpc"] = {}, global._defineProperty));
  ...
  class RpcClient {
    constructor(_ref) {
      ...
      _defineProperty__default["default"](this, "setSend", () => {});
      _defineProperty__default["default"](this, "_send", new Promise(resolve => {
        this.setSend = resolve;
      }));
      _defineProperty__default["default"](this, "peerInfo", new Promise((resolve, reject) => {
        this.resolvePeerInfo = resolve;
        this.rejectPeerInfo = reject;
      }));
      _defineProperty__default["default"](this, "enabledNotifications", []);
      _defineProperty__default["default"](this, "requestHandlers", {});
      _defineProperty__default["default"](this, "subscriptions", {});
      _defineProperty__default["default"](this, "messageListeners", []);
